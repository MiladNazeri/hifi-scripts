(function () {
    ...
    var 
        ...
        DEFAULT_SHOULD_EMIT_SPEED = true,
        DEFAULT_SHOULD_EMIT_RATE = true,
        ...
        DEFAULT_EMIT_SPEED_MIN = 0,
        DEFAULT_EMIT_SPEED_MAX = 75,
        DEFAULT_EMIT_RATE_MIN = 0,
        DEFAULT_EMIT_RATE_MAX = 75
    ;
    ...
    function onEvent(entity) {
        ...
        */
        ...
        if (eventData.note == controlBoxes.emitSpeedControl && SHOULD_EMIT_SPEED) {
            ...
            emitSpeed = lerp(MSG_MIN, MSG_MAX, EMIT_SPEED_MIN, EMIT_SPEED_MAX, eventData.velocity);
            // console.log("intensity1:" + intensity);
            emitSpeed = emitSpeedFilter.process(emitSpeed);
            // console.log("intensity2:" + intensity);

            
            // console.log("eventData.velocity" + eventData.velocity);
            // console.log("entity:" + entity);
            props = { emitSpeed: emitSpeed };
            Entities.editEntity(entity, props);
        }

        if (eventData.note == controlBoxes.emitRateControl && SHOULD_EMIT_RATE) {

            // console.log("MSG_MIN", MSG_MIN)
            // console.log("MSG_MAX", MSG_MAX)
            // console.log("LIGHT_INTENSITY_MIN", LIGHT_INTENSITY_MIN)
            // console.log("LIGHT_INTENSITY_MAX", LIGHT_INTENSITY_MAX)
            emitRate = lerp(MSG_MIN, MSG_MAX, EMIT_RATE_MIN, EMIT_RATE_MAX, eventData.velocity);
            // console.log("intensity1:" + intensity);
            emitRate = emitRateFilter.process(emitRate);
            // console.log("intensity2:" + intensity);

            
            // console.log("eventData.velocity" + eventData.velocity);
            // console.log("entity:" + entity);
            props = { emitRate: emitRate };
            Entities.editEntity(entity, props);
        }
    }
    ...
    AutoLights_Server.prototype = {
        ...
        preload: function (id) {
            ...
            try {
                ...
                SHOULD_EMIT_SPEED = userdataProperties.SHOULD_EMIT_SPEED;
                SHOULD_EMIT_RATE = userdataProperties.SHOULD_EMIT_RATE;
                ...
                EMIT_SPEED_MIN = userdataProperties.EMIT_SPEED_MIN || DEFAULT_EMIT_SPEED_MIN;
                EMIT_SPEED_MAX = userdataProperties.EMIT_SPEED_MAX || DEFAULT_EMIT_SPEED_MAX;
                EMIT_RATE_MIN = userdataProperties.EMIT_RATE_MIN || DEFAULT_EMIT_RATE_MIN;
                EMIT_RATE_MAX = userdataProperties.EMIT_RATE_MAX || DEFAULT_EMIT_RATE_MAX;
                ...
                if (FILTER_TYPE === BUTTERWORTH) {
                    ...
                    emitSpeedFilter = filter.createButterworthFilter();
                    emitRateFilter = filter.createButterworthFilter();
                } else {
                    ...
                    emitSpeedFilter = filter.createAveragingFilter(DAMPINING);
                    emitRateFilter = filter.createAveragingFilter(DAMPINING);
                }
            } catch (e) {
                //
            }
