...
// Procedural Functions
    ...
    function updateControlBoxes(index){
        var array = [makeOneArray(index),makeAllOneArray()];
...
// Message Handlers
    function onEvent() {
        ...
        if (eventData.note == controlBoxes.speedControl) {
            var lerped = lerp(MSG_MIN, MSG_MAX, 0, 20, eventData.velocity);
            speed1 = lerped / 2;
            emitRate = lerped;
        ...
        if (eventData.note == controlBoxes.fallOffRadiusControl) {
            falloffRadius1 = lerp(MSG_MIN, MSG_MAX, 0.00001, 50, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.exponentControl) {
            exponent1 = lerp(MSG_MIN, MSG_MAX, 0.0001, 0.5, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.cutOffControl) {
            cutoff1 = lerp(MSG_MIN, MSG_MAX, 20, 150, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.redControl1) {
            red1 = lerp(MSG_MIN, MSG_MAX, 35, 255, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.greenControl1) {
            green1 = lerp(MSG_MIN, MSG_MAX, 45, 255, eventData.velocity);
            props = { color: { red: red1, green: green1, blue: blue1 } };
            lights.forEach(function(light) { Entities.editEntity(light, props) });
        }
        ...
        if (eventData.note == controlBoxes.blueControl1) {
            blue1 = lerp(MSG_MIN, MSG_MAX, 50, 255, eventData.velocity);
            props = { color: { red: red1, green: green1, blue: blue1 } };
            lights.forEach(function(light) { Entities.editEntity(light, props) });
        }
        ...
        if (eventData.note == controlBoxes.intensityControl1) {
            intensity1 = lerp(MSG_MIN, MSG_MAX, 5, 150, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.intensityControl2) {
            intensity2 = lerp(MSG_MIN, MSG_MAX, 5, 150, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.redControl2) {
            red2 = lerp(MSG_MIN, MSG_MAX, 80, 255, eventData.velocity);
        ...
        if (eventData.note == controlBoxes.greenControl2) {
            green2 = lerp(MSG_MIN, MSG_MAX, 120, 255, eventData.velocity);
            props = { color: { red: red2, green: green2, blue: blue2 } };
            Entities.editEntity(light0, props);
            Entities.editEntity(sphere1, props);
        }
        ...
        if (eventData.note == controlBoxes.blueControl2) {
            blue2 = lerp(MSG_MIN, MSG_MAX, 80, 255, eventData.velocity);
            props = { color: { red: red2, green: green2, blue: blue2 } };
            Entities.editEntity(light0, props);
            Entities.editEntity(sphere1, props);
        }
    ...
    function midiEventReceived(event){
        ...
        eventData.velocity = event.velocity;
        eventData.note = 1;
...
// Tablet
    ...
    var button = null;
    var APP_URL = Script.resolvePath('./Tablet/Layout.html');
