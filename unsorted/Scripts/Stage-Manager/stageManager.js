...
(function() {
    ...
    var appPage = Script.resolvePath('stageManager.html?1');
            ...
            switch (event.type) {
                ...
                case 'spawnWebOverlay' :
                    webOverlaySpawner = Entities.addEntity({
                        ...
                        script: Script.resolvePath('webOverlaySpawner.js?' + Date.now())
                    });
                    break;
    ...
    function createMuteBall(position) {
        var muteBall = Entities.addEntity({
            ...
            name: "Mute All",
            script: "http://hifi-content.s3-us-west-1.amazonaws.com/robin/dev/domains/faceToFace/mute/muteTestHosted.js?123",
            type: "Sphere",
