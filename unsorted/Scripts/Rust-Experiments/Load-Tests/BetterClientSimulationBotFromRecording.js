...
//         "http://mpassets.highfidelity.com/aaa1b0a8-3e1b-492a-9aee-600e5dc907db-v1/F_RetSciSuit.fst"
//      ];
var AVATAR_URL = "https://hifi-content.s3.amazonaws.com/jimi/avatar/Mannequin/hairTest/mannequinHairTest6.fst";

var danceAnimationURL =  "https://hifi-content.s3.amazonaws.com/wadewatts/Dance/Dancing Twerk 456.fbx";
var danceAnimationFPS = 30;
var danceAnimationFrames = 465;

// var  AVATARS_ARRAY[Math.floor(Math.random() * AVATARS_ARRAY.length)];
// print("RANDOM AVATAR SELECTED:" + AVATAR_URL);

// not quite what I want...
var LOCATIONS_ARRAY = [
  { min_x: -40, max_x: -25, y: 4990, min_z: -24, max_z: -10 },
  { min_x: -40, max_x: -25, y: 4990, min_z: -24, max_z: -10 },
  { min_x: -40, max_x: -25, y: 4990, min_z: -24, max_z: -10 },
  { min_x: -40, max_x: -25, y: 4990, min_z: -24, max_z: -10 },
  { min_x: -40, max_x: -25, y: 4990, min_z: -24, max_z: -10 },
...
count = 1000; // This is necessary to wait for the audio mixer to connect
function update(event) {
    ...
    if (count == 0) {
        Avatar.startAnimation(danceAnimationURL, danceAnimationFPS, 1, true, false, 0, danceAnimationFrames);
        count--;
