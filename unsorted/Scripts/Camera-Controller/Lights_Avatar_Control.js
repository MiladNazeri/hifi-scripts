    ...
    function midiEventReceived(eventData) {
        ...
        // Light Fall Off Radius === whiteFader1M
            if (eventData.note == whiteFader1M){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: whiteFader1M, event: eventData}))
        ...
        // Light exponent === whiteFader2M
            if (eventData.note == whiteFader2M){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: whiteFader2M, event: eventData}))
        ...
        // Light cutoff === whiteFader3M
            if (eventData.note == whiteFader3M){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: whiteFader3M, event: eventData}))                
        ...
        // Light Red === redFaderB
            if (eventData.note == redFaderB){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: redFaderB, event: eventData}))                                
        ...
        // Light green === greenFaderA
            if (eventData.note == greenFaderA){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: greenFaderA, event: eventData}))                                                
        ...
        // Lightblue === aquaFaderC
            if (eventData.note == aquaFaderC){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: aquaFaderC, event: eventData}))                                                                
        ...
        // Light Intensity  === whiteFader4M
            if (eventData.note == whiteFader4M){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: whiteFader4M, event: eventData}))                                                                                
        ...
        // Center Light === whiteHorizontalFader
            if (eventData.note == whiteHorizontalFader){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: whiteHorizontalFader, event: eventData}))                                                                                                
        ...
        // ColorControl1 === yellowFaderD
            if (eventData.note == yellowFaderD){
                Messages.sendMessage(messageChannel, JSON.stringify({ type: yellowFaderD, event: eventData}))                                                                                                                                                
